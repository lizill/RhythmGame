...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("neo_aspect_title.png", "neo_aspect.png", "03_neo_aspect_selected.mp3", "03_neo_aspect.mp3"));
		trackList.add(new Track("happy_happy_party_title.png", "happy_happy_party.png", "01_happy_happy_party_selected.mp3", "01_happy_happy_party.mp3"));
		trackList.add(new Track("romeo_title.png", "romeo.png", "02_romeo_selected.mp3", "02_romeo.mp3"));
	...
	public void screenDraw(Graphics2D g) {
		...
		if(isGameScreen) {
			...
			g.drawString("Neo-Aspect", 20, 702);
